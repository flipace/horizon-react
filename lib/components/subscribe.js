...
var emptyList = (0, _seamlessImmutable2.default)([]);
      ...
      _createClass(DataSubscriber, [{
        ...
        value: function shouldComponentUpdate(nextProps) {
          ...
          for (var _i = 0; _i < subscriptionKeys.length; _i++) {
            ...
            if (nextProps.__hz_data[_key] !== this.props.__hz_data[_key]) {
              return true;
            }
          }
        ...
        value: function unsubscribe() {
          ...
          Object.keys(this.subscriptions).forEach(function (k) {
            ...
            sub.query && sub.query.unsubscribe ? sub.query.unsubscribe() : null;
          });
        }
      }, {
        ...
        value: function handleQuery(query, name) {
          ...
          if (query) {
            var sub = (0, _seamlessImmutable2.default)(_extends({}, query._query));

            var objectHash = 'sid_' + (0, _objectHash2.default)(sub);
            this.currentLifeCycleSubscriptions.push(objectHash);

            // early exit in case a subscription like this already
            // exists
            if (typeof this.subscriptions[objectHash] === 'undefined' && this.props.__hz_subscriptions[objectHash]) {
              this.subscriptions[objectHash] = { name: name, hash: objectHash };
              return true;
            ...
            this.subscriptions[objectHash] = {
              name: name,
              hash: objectHash,
              query: query.watch({ rawChanges: true }).subscribe(this.handleData.bind(this, objectHash))
            };

            this.props.dispatch((0, _actionCreators.addSubscription)(sub, objectHash));
          }
        }
        ...
        value: function render() {
          ...
          subscriptionKeys.forEach(function (key) {
            queryData[_this7.subscriptions[key].name] = data[key] || emptyList;
          });
